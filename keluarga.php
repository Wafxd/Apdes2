            ...
            <table class="table table-bordered table-hover">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td class="text-center"><?php echo $kk['jumlah_anggota']; ?> orang</td>
                        <td><?php echo htmlspecialchars($kk['alamat_kk']); ?></td>
                        <td><?php echo $kk['rt'] . '/' . $kk['rw']; ?></td>
                        <td><?php echo htmlspecialchars($kk['dusun']); ?></td>
                        <td>
...
<?php else: 
    ...
    if (mysqli_num_rows($kk_detail) == 0) {
        ...
        // Ambil anggota keluarga dengan data lengkap
                            ...
                            <tr>
                                ...
                                <td colspan="3">
                                    ...
                                    <div id="dusun_input_container" style="display: none;">
                                        <input type="text" class="form-control" name="dusun_custom" id="dusun_custom" placeholder="Tulis nama dusun" oninput="updateDusunHidden('input')">
                                    </div>
                                    
                                    <input type="hidden" name="dusun" id="dusun_hidden">
                                    <small class="text-muted">Pilih dusun dari daftar atau tulis sendiri jika tidak ada</small>
                                </td>
                            </tr>
                            ...
                            <tr>
                                ...
                                <td colspan="3">
                                    ...
                                    <div id="edit_dusun_input_container" style="display: none;">
                                        <input type="text" class="form-control" name="edit_dusun_custom" id="edit_dusun_custom" placeholder="Tulis nama dusun" oninput="updateEditDusunHidden('input')">
                                    </div>
    ...
    fetch('keluarga.php?ajax_get_kk=' + encodeURIComponent(no_kk))
        ...
        .then(result => {
            ...
            if (result.success) {
                ...
                // Reset dusun section dulu
                const editDusunPilih = document.getElementById('edit_dusun_pilih');
                const editDusunTulis = document.getElementById('edit_dusun_tulis');
                const editDusunSelectContainer = document.getElementById('edit_dusun_select_container');
                const editDusunInputContainer = document.getElementById('edit_dusun_input_container');
                const editDusunSelect = document.getElementById('edit_dusun_select');
                const editDusunInput = document.getElementById('edit_dusun_custom');
                const editDusunHidden = document.getElementById('edit_dusun_hidden');
                
                // Set dusun
                if (data.dusun && data.dusun.trim() !== '') {
                    const dusunValue = data.dusun;
                    
                    // Cek apakah dusun ada di daftar
                    let found = false;
                    for (let i = 0; i < editDusunSelect.options.length; i++) {
                        if (editDusunSelect.options[i].value === dusunValue) {
                            editDusunSelect.value = dusunValue;
                            editDusunPilih.checked = true;
                            editDusunSelectContainer.style.display = 'block';
                            editDusunInputContainer.style.display = 'none';
                            editDusunHidden.value = dusunValue;
                            found = true;
                            break;
                        }
                    }
                    ...
                    if (!found) {
                        // Dusun tidak ada di daftar, gunakan input custom
                        editDusunInput.value = dusunValue;
                        editDusunTulis.checked = true;
                        editDusunSelectContainer.style.display = 'none';
                        editDusunInputContainer.style.display = 'block';
                        editDusunHidden.value = dusunValue;
                    }
                } else {
                    // Default ke mode pilih dengan nilai kosong
                    editDusunPilih.checked = true;
                    editDusunSelectContainer.style.display = 'block';
                    editDusunInputContainer.style.display = 'none';
                    editDusunSelect.value = '';
                    editDusunInput.value = '';
                    editDusunHidden.value = '';
                }
                ...
                alert('Gagal mengambil data: ' + (result.message || 'Data tidak ditemukan'));
            }
        })
        .catch(error => {
            console.error('Error:', error);
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    if (btnTambah) {
        btnTambah.addEventListener('click', function(e) {
            ...
            // Reset dusun
            document.getElementById('dusun_pilih').checked = true;
            ...
            document.getElementById('dusun_select').value = '';
            document.getElementById('dusun_custom').value = '';
