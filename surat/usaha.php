...
if (isset($_POST['action']) && $_POST['action'] == 'simpan_surat') {
    ...
    if ($penduduk) {
        ...
        // Gabungkan data usaha ke dalam keterangan
...
if (isset($_POST['action']) && $_POST['action'] == 'download_pdf') {
    ...
    if ($use_dompdf) {
        ...
        header('Content-Disposition: attachment; filename="surat_usaha_' . date('Ymd_His') . '.html"');
        echo $html;
        exit;
    }
}
...
if (isset($_POST['action']) && $_POST['action'] == 'download_word') {
    ...
    // Judul surat
    $section->addText('SURAT KETERANGAN MEMILIKI USAHA', ['bold' => true, 'underline' => 'single'], ['alignment' => Jc::CENTER]);
    $section->addText('Nomor: ' . $no_surat, [], ['alignment' => Jc::CENTER]);
    $section->addTextBreak(1);
    
    // Isi surat
    $section->addText('Yang bertanda tangan di bawah ini kami Kepala Desa SUKOLILO TIMUR Kecamatan Labang Kabupaten Bangkalan, menerangkan bahwa:');
    $section->addTextBreak(0.5);
    
    // Data tabel
    $tableData = $section->addTable(['borderSize' => 0]);
    $dataRows = [
        ['Nama', $penduduk_word['nama_penduduk'] ?? ''],
        ...
        ['Status', $penduduk_word['status_kawin'] ?? ''],
    ...
    $section->addTextBreak(1);
    $section->addText('Menerangkan dengan sebenarnya bahwa orang tersebut benar – benar penduduk Desa SUKOLILO TIMUR Kecamatan Labang Kabupaten Bangkalan, dan bersangkutan benar – benar memiliki Usaha ' . $_POST['jenis_usaha'] . ' dengan nama ' . $_POST['nama_usaha'] . ' yang beralamat di ' . $_POST['alamat_usaha'] . '.');
    $section->addTextBreak(1);
    ...
    $section->addText('KEPALA DESA SUKOLILO TIMUR', ['bold' => true], ['alignment' => Jc::RIGHT]);
    $section->addTextBreak(0.5);
...
<div class="data-card">
    <div class="row">
        ...
        <div class="col-md-6">
            ...
            <div class="mb-2"><span class="data-label">Status</span> : <?php echo $penduduk['status_kawin']; ?></div>
...
<div class="usaha-form">
    <h5 class="mb-3"><i class="fas fa-store me-2"></i>Detail Usaha</h5>
    <div class="row">
        <div class="col-md-4 mb-3">
            <label class="form-label fw-bold">Jenis Usaha</label>
            <select class="form-control" id="jenis_usaha">
                <option value="">Pilih Jenis Usaha</option>
                <option value="Perdagangan" selected>Perdagangan</option>
        ...
        <div class="col-md-4 mb-3">
            ...
            <input type="text" class="form-control" id="nama_usaha" placeholder="Contoh: Toko Sembako Berkah" value="Toko Sembako Berkah">
        </div>
        <div class="col-md-4 mb-3">
            <label class="form-label fw-bold">Alamat Usaha</label>
            <input type="text" class="form-control" id="alamat_usaha" placeholder="Alamat lengkap usaha" value="Dsn. Pangloros Desa Sukolilo Timur">
        </div>
    </div>
</div>
...
<form id="formBuatSurat" method="POST">
    ...
    <div class="card shadow mb-4">
        <div class="card-header py-3 bg-primary text-white d-flex justify-content-between align-items-center">
            <h6 class="m-0 font-weight-bold">
                <i class="fas fa-edit me-2"></i>Editor Surat Keterangan Usaha
            </h6>
        ...
        <div class="surat-body">
            <div class="editor-container" id="editor" contenteditable="true">
                ...
                <div style="text-align: center; margin: 15px 0 15px;">
                    <h4 style="text-decoration: underline; font-weight: bold; margin:0 0 3px 0; font-size: 13pt;">SURAT KETERANGAN MEMILIKI USAHA</h4>
                    <p style="margin:0; font-size: 12pt;">Nomor: <span id="nomor_surat_text" contenteditable="true"><?php echo $nomor_surat_otomatis; ?></span></p>
                </div>
                
                <!-- ISI SURAT -->
                <div style="margin-top: 10px;">
                    <p style="margin:6px 0;">Yang bertanda tangan di bawah ini kami Kepala Desa SUKOLILO TIMUR Kecamatan Labang Kabupaten Bangkalan, menerangkan bahwa:</p>
                    
                    <table style="width: 100%; margin: 10px 0; border-collapse: collapse;">
                        <tr>
                            <td style="width: 130px; padding: 3px; vertical-align: top;">Nama</td>
                        ...
                        <tr>
                            <td style="padding: 3px; vertical-align: top;">Status</td>
                            <td style="padding: 3px; vertical-align: top;">:</td>
                    ...
                    <p style="margin-top: 10px;">Menerangkan dengan sebenarnya bahwa orang tersebut benar – benar penduduk Desa SUKOLILO TIMUR Kecamatan Labang Kabupaten Bangkalan, dan bersangkutan benar – benar memiliki Usaha <span id="jenis_usaha_text" contenteditable="true">Perdagangan</span> dengan nama <span id="nama_usaha_text" contenteditable="true">Toko Sembako Berkah</span> yang beralamat di <span id="alamat_usaha_text" contenteditable="true">Dsn. Pangloros Desa Sukolilo Timur</span>.</p>
            ...
            <div class="row">
                ...
                <div class="col-md-7">
                    ...
                    <div class="btn-group-action">
                        ...
                        <a href="usaha.php" class="btn btn-secondary">
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    // Inisialisasi event listeners untuk form usaha
    initUsahaListeners();
});

// ===== FUNGSI UNTUK FORM USAHA =====
...
function updateHiddenInputs() {
    ...
    const namaUsaha = document.getElementById('nama_usaha').value;
    const alamatUsaha = document.getElementById('alamat_usaha').value;
    
    document.getElementById('hidden_jenis_usaha').value = jenisUsaha;
    document.getElementById('hidden_nama_usaha').value = namaUsaha;
    document.getElementById('hidden_alamat_usaha').value = alamatUsaha;
}
