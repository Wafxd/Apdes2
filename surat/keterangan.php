...
if (isset($_POST['action']) && $_POST['action'] == 'simpan_surat') {
    ...
    if ($penduduk) {
        ...
        // Gabungkan data ke dalam keterangan
...
if (isset($_POST['action']) && $_POST['action'] == 'download_pdf') {
    ...
    if ($use_dompdf) {
        ...
        header('Content-Disposition: attachment; filename="surat_keterangan_' . date('Ymd_His') . '.html"');
        echo $html;
        exit;
    }
}
...
if (isset($_POST['action']) && $_POST['action'] == 'download_word') {
    ...
    // Judul surat
    $section->addText('SURAT KETERANGAN', ['bold' => true, 'underline' => 'single'], ['alignment' => Jc::CENTER]);
    ...
    $section->addTextBreak(1);
    $section->addText('Menerangkan dengan sebenarnya orang tersebut diatas adalah benar-benar Penduduk Desa Sukolilo Timur Kecamatan Labang Kabupaten Bangkalan dan Surat Keterangan ini dikeluarkan untuk ' . $_POST['keperluan'] . '.');
    $section->addTextBreak(1);
...
<div class="data-card">
    <div class="row">
        ...
        <div class="col-md-6">
            ...
            <div class="mb-2"><span class="data-label">Status Perkawinan</span> : <?php echo $penduduk['status_kawin']; ?></div>
...
<!-- Form Keperluan -->
<div class="keperluan-form">
    <h5 class="mb-3"><i class="fas fa-pencil-alt me-2"></i>Keperluan Surat</h5>
    <div class="row">
        <div class="col-md-12 mb-3">
            <label class="form-label fw-bold">Keperluan Surat Ini</label>
            <textarea class="form-control" id="keperluan_text" rows="3" placeholder="Contoh: Melamar Pekerjaan, Mengurus Administrasi, Persyaratan Sekolah, dll">Melamar Pekerjaan</textarea>
            <small class="text-muted">Isi dengan keperluan pembuatan surat ini</small>
        </div>
    </div>
</div>
...
<form id="formBuatSurat" method="POST">
    ...
    <div class="card shadow mb-4">
        <div class="card-header py-3 bg-primary text-white d-flex justify-content-between align-items-center">
            <h6 class="m-0 font-weight-bold">
                <i class="fas fa-edit me-2"></i>Editor Surat Keterangan
            </h6>
        ...
        <div class="surat-body">
            <div class="editor-container" id="editor" contenteditable="true">
                ...
                <div style="text-align: center; margin: 15px 0 15px;">
                    <h4 style="text-decoration: underline; font-weight: bold; margin:0 0 3px 0; font-size: 13pt;">SURAT KETERANGAN</h4>
            ...
            <div class="row">
                ...
                <div class="col-md-7">
                    ...
                    <div class="btn-group-action">
                        ...
                        <a href="keterangan.php" class="btn btn-secondary">
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    // Inisialisasi event listeners untuk form keperluan
    initKeperluanListeners();
});

// ===== FUNGSI UNTUK FORM KEPERLUAN =====
