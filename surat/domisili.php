...
if (isset($_POST['action']) && $_POST['action'] == 'simpan_surat') {
    ...
    if ($penduduk) {
        ...
        // Keterangan bisa diisi dengan data tambahan jika diperlukan
        $keterangan = "Surat Keterangan Domisili untuk " . $nama_pemohon;
                ...
                <div class="col-md-5">
                    ...
                    <div class="form-group mt-2">
                        ...
                        <input type="text" class="form-control" id="keperluan" name="keperluan" 
                               placeholder="Contoh: Pembuatan KTP, Melamar Kerja, dll">
                    </div>
                </div>
                <div class="col-md-7">
                    <br>
