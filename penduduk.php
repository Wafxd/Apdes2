...
// Query data dengan cek penggunaan yang benar
$query = "SELECT p.*, 
                ...
                <tbody>
                    <?php if (mysqli_num_rows($result) > 0): ?>
                        ...
                        <tr>
                            ...
                            <td><?php echo htmlspecialchars($row['dusun'] ?? '-'); ?></td>
                            <td>
                                <?php 
                                if ($row['is_kepala'] > 0): 
                                ?>
...
<div class="modal fade" id="tambahPendudukModal" tabindex="-1" aria-labelledby="tambahPendudukModalLabel" aria-hidden="true" data-bs-backdrop="static">
    <div class="modal-dialog modal-xl modal-dialog-scrollable">
        <div class="modal-content">
            ...
            <form method="POST" action="penduduk.php" id="formTambahPenduduk" onsubmit="return validateFormTambah()">
                    ...
                    <div class="container-fluid p-3">
                        ...
                        <table class="table table-borderless" style="width: 100%;">
                            ...
                            <tr>
                                ...
                                <td style="width: 35%;">
                                    <input type="text" class="form-control text-uppercase" name="nama_penduduk" id="tambah_nama" required placeholder="Masukkan nama lengkap">
                                </td>
                            </tr>
                            ...
                            <tr>
                                ...
                                <td>
                                    <input type="text" class="form-control text-uppercase" name="nama_ayah" id="tambah_nama_ayah" placeholder="Masukkan nama ayah">
                                </td>
                                <td style="vertical-align: middle;">
                                    <label class="form-label fw-bold mb-0">Nama Ibu</label>
                                </td>
                                <td>
                                    <input type="text" class="form-control text-uppercase" name="nama_ibu" id="tambah_nama_ibu" placeholder="Masukkan nama ibu">
                                </td>
                            </tr>
                            ...
                            <tr>
                                ...
                                <td>
                                    <input type="text" class="form-control text-uppercase" name="tempat_lahir" id="tambah_tempat_lahir" placeholder="Contoh: JAKARTA">
                                </td>
                                <td style="vertical-align: middle;">
                            ...
                            <tr>
                                ...
                                <td>
                                    <input type="text" class="form-control text-uppercase" name="pekerjaan" id="tambah_pekerjaan" placeholder="Contoh: PNS, SWASTA, PETANI">
                                </td>
                            </tr>
                                ...
                                <td colspan="3">
                                    <div class="dusun-toggle mb-2">
                                        <div class="form-check form-check-inline">
                                            ...
                                            <label class="form-check-label" for="dusun_pilih">Pilih dari daftar</label>
                                        </div>
                                        <div class="form-check form-check-inline">
                                            <input class="form-check-input" type="radio" name="dusun_option" id="dusun_tulis" value="tulis" onclick="toggleDusun('tulis')">
                                            <label class="form-check-label" for="dusun_tulis">Tulis sendiri</label>
                                        </div>
                                    </div>
                                    ...
                                    <div id="dusun_input_container" style="display: none;">
                                        <input type="text" class="form-control text-uppercase" name="dusun_custom" id="dusun_custom" placeholder="Tulis nama dusun" oninput="updateDusunHidden('input')">
                                    </div>
                                    
                                    <input type="hidden" name="dusun" id="dusun_hidden">
                                    <small class="text-muted">Pilih dusun atau tulis sendiri jika tidak ada dalam daftar</small>
                                </td>
                            </tr>
                            
                            <!-- Baris 8: Alamat (full width) -->
                            <tr>
                                <td style="vertical-align: top;">
                                    <label class="form-label fw-bold mb-0">Alamat</label>
                                </td>
                                <td colspan="3">
                                    <textarea class="form-control text-uppercase" name="alamat" id="tambah_alamat" rows="2" placeholder="Masukkan alamat lengkap"></textarea>
                                </td>
                            </tr>
                            
                            <!-- Baris 9: Kelurahan/Desa, Kecamatan, Kabupaten/Kota -->
                            <tr>
                                <td style="vertical-align: middle;">
                                ...
                                <td>
                                    <input type="text" class="form-control text-uppercase" name="kecamatan" id="tambah_kecamatan" value="SUKOLILO">
                                </td>
                            </tr>
                            
                            <!-- Baris 10: Kabupaten/Kota, Provinsi, Kode Pos -->
                            <tr>
                                <td style="vertical-align: middle;">
                                ...
                                <td>
                                    <input type="text" class="form-control text-uppercase" name="provinsi" id="tambah_provinsi" value="JAWA TIMUR">
                                </td>
                            </tr>
...
<div class="modal fade" id="editPendudukModal" tabindex="-1" aria-labelledby="editPendudukModalLabel" aria-hidden="true" data-bs-backdrop="static">
    <div class="modal-dialog modal-xl modal-dialog-scrollable">
        <div class="modal-content">
            ...
            <form method="POST" action="penduduk.php" id="formEditPenduduk" onsubmit="return validateFormEdit()">
                <div class="modal-body" style="max-height: 70vh; overflow-y: auto;">
                    <div class="container-fluid p-3">
                        <!-- Table layout tanpa border yang terlihat -->
                        <table class="table table-borderless" style="width: 100%;">
                                ...
                                <td colspan="3">
                                    <div class="dusun-toggle mb-2">
                                        <div class="form-check form-check-inline">
                                            ...
                                            <label class="form-check-label" for="edit_dusun_pilih">Pilih dari daftar</label>
                                        </div>
                                        <div class="form-check form-check-inline">
                                            ...
                                            <label class="form-check-label" for="edit_dusun_tulis">Tulis sendiri</label>
                                        </div>
                                    </div>
                                    ...
                                    <div id="edit_dusun_input_container" style="display: none;">
                                        <input type="text" class="form-control text-uppercase" name="edit_dusun_custom" id="edit_dusun_custom" placeholder="Tulis nama dusun" oninput="updateEditDusunHidden('input')">
                                    </div>
...
/* Styling untuk dusun toggle */
.dusun-toggle {
    margin-top: 5px;
}

.dusun-toggle .form-check {
...
function toggleDusun(mode) {
    const selectContainer = document.getElementById('dusun_select_container');
    const inputContainer = document.getElementById('dusun_input_container');
    const select = document.getElementById('dusun_select');
    const input = document.getElementById('dusun_custom');
    const hidden = document.getElementById('dusun_hidden');
...
function updateDusunHidden(source) {
    const hidden = document.getElementById('dusun_hidden');
    const select = document.getElementById('dusun_select');
    const input = document.getElementById('dusun_custom');
...
function toggleEditDusun(mode) {
    const selectContainer = document.getElementById('edit_dusun_select_container');
    const inputContainer = document.getElementById('edit_dusun_input_container');
    const select = document.getElementById('edit_dusun_select');
    const input = document.getElementById('edit_dusun_custom');
...
function updateEditDusunHidden(source) {
    const hidden = document.getElementById('edit_dusun_hidden');
    const select = document.getElementById('edit_dusun_select');
    const input = document.getElementById('edit_dusun_custom');
...
function validateFormTambah() {
    // Update dusun hidden sebelum submit
    const dusunOption = document.querySelector('input[name="dusun_option"]:checked');
    if (dusunOption) {
        if (dusunOption.value === 'pilih') {
            updateDusunHidden('select');
        } else {
            updateDusunHidden('input');
        }
    }
...
function validateFormEdit() {
    ...
    if (dusunOption) {
        if (dusunOption.value === 'pilih') {
            updateEditDusunHidden('select');
        } else {
            updateEditDusunHidden('input');
        }
    }
    
    const nik = document.getElementById('edit_nik')?.value;
    const nama = document.getElementById('edit_nama_penduduk')?.value;
    const tanggal = document.getElementById('edit_tanggal_lahir')?.value;
    ...
    if (!nama) {
        alert('Nama harus diisi!');
        document.getElementById('edit_nama_penduduk')?.focus();
        return false;
    }
    
    if (!tanggal) {
        alert('Tanggal lahir harus diisi!');
        document.getElementById('edit_tanggal_lahir')?.focus();
        return false;
    }
                        ...
                        <div class="row">
                                ...
                                <div class="card mb-3">
                                    ...
                                    <div class="card-body">
                                        <table class="table table-sm table-borderless">
                                            <tr><td width="40%" class="text-muted">Tempat Lahir</td><td>: <strong>${data.tempat_lahir || '-'}</strong></td></tr>
                                            <tr><td class="text-muted">Tanggal Lahir</td><td>: <strong>${tglLahir}</strong></td></tr>
                                            <tr><td class="text-muted">Umur</td><td>: <strong>${umur}</strong></td></tr>
                                            <tr><td class="text-muted">Jenis Kelamin</td><td>: <strong>${data.jenis_kelamin || '-'}</strong></td></tr>
                                            <tr><td class="text-muted">Agama</td><td>: <strong>${data.agama || '-'}</strong></td></tr>
                                            <tr><td class="text-muted">Status Kawin</td><td>: <strong>${data.status_kawin || '-'}</strong></td></tr>
                                            <tr><td class="text-muted">Pendidikan</td><td>: <strong>${data.pendidikan || '-'}</strong></td></tr>
                                            <tr><td class="text-muted">Pekerjaan</td><td>: <strong>${data.pekerjaan || '-'}</strong></td></tr>
                                        </table>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="col-md-6">
                                <div class="card mb-3">
                                    ...
                                    <div class="card-body">
                                        <table class="table table-sm table-borderless">
                                            <tr><td width="40%" class="text-muted">Nama Ayah</td><td>: <strong>${data.nama_ayah || '-'}</strong></td></tr>
                                            <tr><td class="text-muted">Nama Ibu</td><td>: <strong>${data.nama_ibu || '-'}</strong></td></tr>
                                        </table>
                                    </div>
                                </div>
                                ...
                                <div class="card mb-3">
                                    ...
                                    <div class="card-body">
                                        <table class="table table-sm table-borderless">
                                            <tr><td width="40%" class="text-muted">Alamat</td><td>: <strong>${data.alamat || '-'}</strong></td></tr>
                                            <tr><td class="text-muted">Dusun</td><td>: <strong>${data.dusun || '-'}</strong></td></tr>
                                            <tr><td class="text-muted">RT/RW</td><td>: <strong>${data.rt_rw || '-'}</strong></td></tr>
                                            <tr><td class="text-muted">Kelurahan/Desa</td><td>: <strong>${data.kel_des || '-'}</strong></td></tr>
                                            <tr><td class="text-muted">Kecamatan</td><td>: <strong>${data.kecamatan || '-'}</strong></td></tr>
                                            <tr><td class="text-muted">Kabupaten/Kota</td><td>: <strong>${data.kabupaten_kota || '-'}</strong></td></tr>
                                            <tr><td class="text-muted">Provinsi</td><td>: <strong>${data.provinsi || '-'}</strong></td></tr>
                                            <tr><td class="text-muted">Kode Pos</td><td>: <strong>${data.kodepos || '-'}</strong></td></tr>
                                        </table>
                                    </div>
                                </div>
                            </div>
    ...
    fetch('penduduk.php?ajax_get_penduduk=' + encodeURIComponent(nik))
        ...
        .then(result => {
            ...
            if (result.success) {
                ...
                // Set dusun
                if (data.dusun) {
                    const dusunValue = data.dusun;
                    const select = document.getElementById('edit_dusun_select');
                    const input = document.getElementById('edit_dusun_custom');
                    const hidden = document.getElementById('edit_dusun_hidden');
                    
                    // Cek apakah dusun ada di daftar
                    let found = false;
                    for (let i = 0; i < select.options.length; i++) {
                        if (select.options[i].value === dusunValue) {
                            select.value = dusunValue;
                            document.getElementById('edit_dusun_pilih').checked = true;
                    ...
                    if (!found && dusunValue) {
                        input.value = dusunValue;
                        document.getElementById('edit_dusun_tulis').checked = true;
...
function showInfoPenggunaan(nik, nama, isKepala, isAnggota) {
    ...
    let content = `
        ...
        <table class="table table-sm table-borderless">
            <tr><td width="40%" class="text-muted">NIK</td><td><strong>${nik}</strong></td></tr>
            <tr><td class="text-muted">Nama</td><td><strong>${nama}</strong></td></tr>
        </table>
        <hr>
    `;
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    const formEdit = document.getElementById('formEditPenduduk');
    if (formEdit) {
...
window.validateFormEdit = validateFormEdit;
...
window.toggleDusun = toggleDusun;
window.toggleEditDusun = toggleEditDusun;
window.updateDusunHidden = updateDusunHidden;
window.updateEditDusunHidden = updateEditDusunHidden;
</script>
