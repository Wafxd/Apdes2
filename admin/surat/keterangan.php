...
function getNomorSuratBerikutnya($conn, $jenis_surat = 'SK') {
    $tahun = date('Y');
    ...
    if (mysqli_num_rows($result) > 0) {
        ...
        if (count($parts) == 4) {
            ...
            return $nomor . ' / ' . $parts[1] . ' / ' . $parts[2] . ' / ' . $parts[3];
        }
    }
    return '1 / 42 / 433.311.5 / ' . $tahun;
}
...
if (isset($_POST['action']) && $_POST['action'] == 'simpan_surat') {
    ...
    if ($penduduk) {
        ...
        $keterangan = "Keperluan: $keperluan";
    ...
    header("Location: keterangan.php?nik=" . urlencode($nik));
    exit();
}
...
if (isset($_POST['action']) && $_POST['action'] == 'download_pdf') {
    ...
    $dompdf->render();
    $dompdf->stream("surat_keterangan_" . date('Ymd_His') . ".pdf", array("Attachment" => true));
    exit;
}
...
if (isset($_POST['action']) && $_POST['action'] == 'download_word') {
    ...
    $section->addText('SURAT KETERANGAN', ['bold' => true, 'underline' => 'single', 'size'=>13], ['alignment' => Jc::CENTER]);
    ...
    $section->addTextBreak(0.5);
    $keperluan_word = $_POST['keperluan'] ?? 'Melamar Pekerjaan';
    
    $section->addText('Menerangkan dengan sebenarnya orang tersebut diatas adalah benar-benar Penduduk Desa Sukolilo Timur Kecamatan Labang Kabupaten Bangkalan dan Surat Keterangan ini dikeluarkan untuk ' . $keperluan_word . '.');
    $section->addTextBreak(0.5);
    ...
    $filename = "surat_keterangan_" . date('Ymd_His') . ".docx";
...
// ==================== AMBIL DATA PENDUDUK ====================
$penduduk = null;
$nomor_surat_otomatis = getNomorSuratBerikutnya($conn, 'SK');
...
$pageTitle = "Surat Keterangan Umum";
...
.data-card.keperluan-form { border-left: 5px solid #36b9cc; } /* Info/Cyan untuk form keperluan */
...
.keperluan-form .form-control:focus { border-color: #36b9cc; box-shadow: 0 0 0 0.2rem rgba(54, 185, 204, 0.25); }
...
<div class="data-card keperluan-form">
    <h5 class="font-weight-bold text-info border-bottom pb-3 mb-4"><i class="fas fa-edit me-2"></i>Maksud dan Tujuan Surat</h5>
    <div class="row">
        <div class="col-md-12 mb-2">
            <label class="form-label fw-bold">Tuliskan Keperluan Pembuatan Surat Ini</label>
            <div class="input-group shadow-sm">
                <span class="input-group-text bg-white"><i class="fas fa-pen-fancy text-info"></i></span>
                <textarea class="form-control border-start-0" id="keperluan_text" rows="2" placeholder="Contoh: Mengurus Beasiswa, Pendaftaran Sekolah, Melamar Kerja, dll">Melamar Pekerjaan</textarea>
            </div>
            <small class="text-muted mt-2 d-inline-block"><i class="fas fa-info-circle me-1"></i> Teks yang diketik akan otomatis muncul di dalam paragraf surat di bawah.</small>
        </div>
    </div>
</div>
        ...
        <div class="editor-workspace">
            <div class="editor-container paper-a4" id="editor" contenteditable="true" style="padding: 2cm 2cm 2cm 3cm; font-family: 'Times New Roman', Times, serif; font-size: 12pt;">
                ...
                <div style="text-align: center; margin: 15px 0 20px; color: #000;">
                    <h4 style="text-decoration: underline; font-weight: bold; margin:0 0 3px 0; font-size: 13pt; color: #000;">SURAT KETERANGAN</h4>
                ...
                <div style="color: #000;">
                    ...
                    <p style="margin-bottom: 10px; line-height: 1.6;">Menerangkan dengan sebenarnya orang tersebut diatas adalah benar-benar Penduduk Desa Sukolilo Timur Kecamatan Labang Kabupaten Bangkalan dan Surat Keterangan ini dikeluarkan untuk <span id="keperluan_surat" contenteditable="true" style="font-weight: bold;">Melamar Pekerjaan</span>.</p>
                    ...
                    <table class="action-table">
                        ...
                        <tr>
                            <td colspan="2" style="padding-top: 5px;">
                                <a href="keterangan.php" class="btn-action btn-preview" style="background: #fdfdfd;">
    ...
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content border-0">
            ...
            <div class="modal-body text-center py-5">
                ...
                <p class="text-muted mb-4">Pastikan data penduduk dan keperluan sudah benar sebelum menyimpan.</p>
...
if (searchInput) {
    searchInput.addEventListener('input', function() {
        ...
        searchTimeout = setTimeout(() => {
            fetch('keterangan.php?search_penduduk=' + encodeURIComponent(keyword))
